...
// MARK: - Enum
enum LeaveTypeEmployee: String, CaseIterable, Identifiable {
...
struct LeaveTypeSection: View {
    @Binding var selectedType: LeaveTypeEmployee?
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 12) {
            ...
            VStack(spacing: 10) {
                ForEach(LeaveTypeEmployee.allCases) { type in
